# Contributing to Puente Cloud Code
...
issue](https://github.com/hopetambala/puente-node-cloudcode/issues) before anybody
...
Short answer: with pull requests to the  Puente-Node-CloudCode repository.

All decisions affecting Puente-Node-CloudCode follow the same 3 steps:
...
* 2) Be available to anyone with questions, bug reports, criticism etc. on Puente-Node-CloudCode.
